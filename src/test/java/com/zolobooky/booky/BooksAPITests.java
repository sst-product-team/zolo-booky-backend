...
public class BooksAPITests {
	...
	//
	// private void testSuccessPOSTRequest(String endpoint, String jsonModel) throws
	// Exception {
	// mockMvc
	...
	// }
	//
	// private void testFailurePOSTRequest(String endpoint, String jsonModel, int ec)
	// throws Exception {
	// if (ec == 400)
	// mockMvc
	// .perform(post(endpoint).contentType(MediaType.APPLICATION_JSON)
