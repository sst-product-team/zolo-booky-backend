...
// throw new FireSendingError(String.format("error sending notifications, error: %s",
// t.getMessage()));
// }
//
// @Override
// public void onSuccess(String result) {
// log.info(String.format("Notification sent Successfully to fcm: %s, result: %s", token,
// result));
// }
// });
// }
